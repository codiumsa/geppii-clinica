Bodega.ApplicationView = Ember.View.extend({
    ...
    didInsertElement: function() {
        ...
        $(window).resize(function() {
            appController.set('containerHeight', Bodega.newHeightWrapper());
        });
             
    },
});

Bodega.newHeightWrapper = function(detalle) {
    ...
    if (detalle) {
        var detalleHeight = 30 * $('.form-detalles > .form-group').length;
        //console.log('detalleHeight height  %s', $('.form-detalles > .form-group').last().height());
        //console.log('detalleHeight length %s', $('.form-detalles > .form-group').length);
        //console.log('detalleHeight %s', detalleHeight);
        newHeight = newHeight + detalleHeight;
    }

    console.log('newHeight %s', newHeight);
    return newHeight + 200;
}
