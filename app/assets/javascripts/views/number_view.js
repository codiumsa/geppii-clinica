Bodega.NumberField = Em.TextField.extend({
  ...
  formatNumber: function(number){
    return number ? number.toString().replace(/^0+/, '').replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.") : "0";
  },
...
Ember.Handlebars.helper("number-field", Bodega.NumberField);