...
Bodega.FileUploadModel = Ember.Object.extend({
    init: function() {
        this._super();
    ...
    readFile: function() {
        ...
        this.set('size', Bodega.humanReadableFileSize(fileToUpload.size));
    ...
    //    
    uploadFile: function(id, factory, restVerb) {
        ...
        var attribute = restVerb;
        var urlService = api + factory +'/' + id + '/' + attribute;
        var self = this;
...
Bodega.humanReadableFileSize = function(size) {
    var label = "";
    if(size == 0) {
        label = "0 KB";
