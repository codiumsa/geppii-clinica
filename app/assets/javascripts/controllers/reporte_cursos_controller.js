Bodega.ReporteCursosIndexController = Ember.ArrayController.extend({
    formTitle: 'Reporte de Cursos',
    ...
    search: function() {
      ...
      if(fechaAntes && fechaDia){
        ...
        Bodega.Notification.show('Error','Seleccione un rango de fechas válido',Bodega.Notification.ERROR_MSG);
          ...
          Bodega.$.fileDownload("/api/v1/cursos", downloadParams);
      }
