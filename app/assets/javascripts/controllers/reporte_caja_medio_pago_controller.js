Bodega.ReporteCajaMedioPagoIndexController = Ember.ArrayController.extend({
  formTitle: 'Reporte de Caja por Medio de Pago',
  ...
  actions: {
    search: function() {
      ...
      params.tipo = 'reporte_caja_medio_pago';
      // params.by_tipo_operacion = 'cierre';
