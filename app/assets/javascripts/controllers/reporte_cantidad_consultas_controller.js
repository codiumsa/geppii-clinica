Bodega.ReporteCantidadConsultasIndexController = Ember.ArrayController.extend({
  formTitle: 'Reporte de Cantidad de Consultas',
  ...
  actions: {
    search: function() {
      ...
      params.tipo = 'reporte_cantidad_consultas';
      ...
      if(this.get('fecha_inicio_antes')){
        params.by_fecha_agenda_after_before = this.get ('fecha_inicio_antes');
      }
