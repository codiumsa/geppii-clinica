Bodega.ReporteCantidadPacientesAtendidosIndexController = Ember.ArrayController.extend({
  formTitle: 'Reporte de Cantidad de Pacientes Atendidos',
  ...
  actions: {
    search: function() {
      ...
      params.tipo = 'reporte_cantidad_pacientes_atendidos';
      params.by_estado = "ATENDIDO";
